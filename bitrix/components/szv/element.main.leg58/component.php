    ...
    <table>
      <tbody>
        <tr>
          ...
          <td width="50%">
            <img src="/bitrix/images/seotime/img/icon10.png" alt="">
             <p>Паркинг в подарок! до 500 тыс. руб. экономии!</p>
          </td>
        </tr>
        <tr>
          <td width="50%">
...
<!-- op2 -->
  ...
  <div class="objectPropertiesRightSide">                         
    ...
    <div class="overview">
      <ul>
        ...
        <li>Приморский район. Прописка городская</li>
  ...
  <div class="objectPropertiesLeftSide">
    ...
    <div class="heading">Квартиры от 2,6 млн руб.<span>C "белой" отделкой в подарок!</span></div>
  </div>
</div>
	<!-- /op2 -->
...
<div class="objectProperties objectProperties3">
  ...
  <div class="objectPropertiesRightSide">
    ...
    <div class="heading">Скидки от 300 тыс.<br>до 1,5 млн рублей!<span>на покупку квартир<br>в этом комплексе</span></div>
  ...
  <div class="objectPropertiesLeftSide">
    ...
    <div class="heading">Паркинг в подарок в марте!<br>Экономия до 500 тыс. руб</div>
    <p>Двухуровневый подземный паркинг оснащен<br>системами видеонаблюдения. Удобный подъем<br>к квартирам с паркинга на лифтах!</p>
    <div class="note">Торопитесь, предложение ограничено!</div>
  </div>
</div>
	<!-- /op3 -->
