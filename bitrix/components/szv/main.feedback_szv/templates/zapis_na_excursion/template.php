...
<div class="popup_title"></div>
		<div class="suggestion"><p><span>Записаться на экскурсию</span></p>

<table style="margin-left: 0;">
	<tr><td><input type="text" name="jk" placeholder="Название ЖК"></td></tr>
	...
	<tr><td><input type="text" name="telefon" class="alloka-catch-form-input-phone" placeholder="Ваш телефон" required></td></tr>
</table>
  	    ...
  	    <tr>
            <td>
                <div class="popup_send_box">
                    <input style="width: 200px" class="popup_send" onclick="yaCounter21785827.reachGoal($('.mainForm .purposeMetr').val());$.ajax({ url: '/include/sendCallTouch.php', dataType: 'html', type: 'POST', data: $('.mainForm').serialize(), success: function(data) { } });" type="submit" name="submit_popup" value="Записаться" />
                </div>
            </td>
            </tr>
        </table>
