...
input.value = input.value.replace(" ", ""); //edited by coder
...
JCSmartFilter.prototype.postHandler = function (result)
{
	...
	if (!!result && !!result.ITEMS)
	{
		...
		if (!!modef && !!modef_num)
		{
			...
			set_filter.value = 'Показать варианты ('+result.ELEMENT_COUNT+')';
...
BX.Iblock.SmartFilter = (function()
{
	...
	SmartFilter.prototype.recountMinPrice = function()
	{
		...
		var showMinPrice = (newMinPrice > 500000 ? Number((newMinPrice/1000000).toFixed(1)) : newMinPrice);
	...
	SmartFilter.prototype.recountMaxPrice = function()
	{
		...
		var showMaxPrice = (newMaxPrice > 500000 ? Number((newMaxPrice/1000000).toFixed(1)) : newMaxPrice);
