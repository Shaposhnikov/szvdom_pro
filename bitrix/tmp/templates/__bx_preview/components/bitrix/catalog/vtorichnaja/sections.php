...
if (isset($arParams["USE_SELECT_TEMP"]) && $arParams["USE_SELECT_TEMP"] == "Y")
{
    $temp = "select";
    $count = "all";
}else{
...
$APPLICATION->AddChainItem("Выборка", "");
...
?><?$intSectionID = $APPLICATION->IncludeComponent(
	...
	array(
        ...
        "SHOW_ALL_WO_SECTION" => (isset($arParams["USE_SELECT_TEMP"]) && $arParams["USE_SELECT_TEMP"] == "Y")? "Y": "N",
		...
		"SECTION_CODE" => "vtorichnaja", //$arResult["VARIABLES"]["SECTION_CODE"],
