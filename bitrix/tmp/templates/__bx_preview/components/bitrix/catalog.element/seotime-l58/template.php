...
<!--<div><h1>#SEO#</h1></div>-->
<div><h1>ЖК "Легенда Комендантского"</h1></div>
    <?
...
<div class="ipoteka-partners">
      ...
      <div class="partners-img"><img src="/bitrix/images/seotime/img/partners_komend.jpg" alt="Подбор лучшего предложения от ведущих банков партнеров"></div>
    </div>
<!-- / partners -->
...
<div class="see-also">
  ...
  <div class="see-also-block">
    <img src="/bitrix/images/seotime/img/also01.jpg" alt="">
    <a href="http://szvdom.ru/obekty/zhk-legenda-na-dalnevostochnom-12/"><strong>ЖК Легенда Дальневосточного</strong>от 3,7 млн руб</a>
  </div>
  <div class="see-also-block">
...
<div class="elementDesc mainPageContent">
  <div class="overview">
    ...
    <h1>Квартиры в ЖК «Легенда Комендантского»</h1>
    <p>Комплекс находится в одном из самых красивых районов СПб — Приморском. С одной стороны от него расположились Юнтоловский лесопарк и ЗСД, с другой — Новоорловский лесопарк и ул. Парашютная. Благодаря этому у жильцов не будет проблем ни с транспортной доступностью к другим частям города и пригороду, ни с местами для прогулок и занятий спортом.</p>
    <h2>О комплексе и условиях покупки</h2>
    <p>Первая очередь домов будет сдана весной 2018 года, поэтому предложенные сегодня в ЖК Легенда на Комендантском 58 цены вас приятно удивят. Однокомнатная квартира студийного формата будет стоить от 1,9 млн рублей.</p>
    ...
    <p>Более подробную информацию о жилом комплексе «Легенда на Комендантском 58» Вы всегда можете получить, связавшись с отделом продаж как по телефону +7 (812) 902-50-50, так и с помощью онлайн формы связи, на официальном сайте компании «Созвездие недвижимости».</p>
