...
<div class="footer">
	...
	<? if (!preg_match('#/obekty/zhk-legenda-na-komendantskom-58/.*#siU', $_SERVER['REQUEST_URI']) && !preg_match('#/obekty/zhk-legenda-na-dalnevostochnom-12/.*#siU', $_SERVER['REQUEST_URI']) ) {  ?>

    <? if (strstr($APPLICATION->GetCurPage(),'/obekty/') ||
          (strpos($APPLICATION->GetCurPage(),'/obekty/') === false) && (strpos($APPLICATION->GetCurPage(),'/vyborki/') === false) && (strpos($APPLICATION->GetCurPage(),'/akcii-i-skidki/') === false) ){?>
...
<?
// Добавляем исключение выборок для карточки ЖК
?>

<?

if (preg_match ("/obekty/",$APPLICATION->GetCurPage()) && !($APPLICATION->GetCurPage() === "/obekty/")) 
	$viborka_id = 81;

elseif (!(strpos($APPLICATION->GetCurPage(),"/vtorichnaja/") === false) || (isset($GLOBALS['vtorichnaja'])))
	$viborka_id = 79;
else
	$viborka_id = 80;
?>
...
?>
	...
	<div class="footerbox">
        <a onclick="yaCounter21785827.reachGoal('select_footer', function () { alert('Данные успешно отправлены');}, 'Показать выборку'); return true;"class="showIt" data-who="podbor_feedback" style="display: inline-block;vertical-align: top;margin-right: -60px;margin-top: 72px;"><img src="/bitrix/templates/szvdom/images/vkladka_podbor.png"></a>
        ...
        <a onclick="yaCounter21785827.reachGoal('week_footer', function () { alert('Данные успешно отправлены');}, 'Показать выборку'); return true;" class="showIt" data-who="skidki_feedback" style="display: inline-block;vertical-align: top;margin-right: -45px;margin-top: 75px;"><img src="/bitrix/templates/szvdom/images/vkladka_zapis.png"></a>
		<a onclick="yaCounter21785827.reachGoal('form_footer'); return true;" class="showIt callibri_phone cpc2" data-who="otv_vopr_feedback" style="display: inline-block;position:relative;vertical-align:top;margin-top: 52px;margin-right:-20px;background: url('/bitrix/templates/szvdom/images/vknadka_number.png')no-repeat;width: 303px;height: 68px;" class="callibri_phone">
...
<script defer type="text/javascript" src="<?= SITE_TEMPLATE_PATH ?>/js/jquery.fs.scroller.min.js"></script>
<script defer  type="text/javascript" src="<?= SITE_TEMPLATE_PATH ?>/js/maphilight.js"></script>
<script defer  type="text/javascript" src="<?= SITE_TEMPLATE_PATH ?>/js/jscript.js"></script>
<script defer  type="text/javascript" src="<?= SITE_TEMPLATE_PATH ?>/js/jquery.tinycarousel.min.js"></script>
<script defer  type="text/javascript" src="<?= SITE_TEMPLATE_PATH ?>/js/ipotCalc.js"></script>
<script defer  type="text/javascript" src="<?= SITE_TEMPLATE_PATH ?>/js/jquery.tinyscrollbar.min.js"></script>
<!-- edited by coder 28.04.2016 -->
<script defer  type="text/javascript" src="<?= SITE_TEMPLATE_PATH ?>/js/slick.js"></script>
<!-- end of edit -->

<div style="display:none">
<!-- _new -->
	<script defer  type="text/javascript" src="/bitrix/images/seotime/js/jquery.maskedinput.min.js"></script>
<script>
    $(function() {
        $.mask.definitions['~'] = "[+-]";
...
?>
	...
	<div id="favor"><a href="" rel="sidebar" onclick="return bookmark(this);"><div id="favor2"></div></a></div>
...
<script type="text/javascript" src="//api.venyoo.ru/wnew.js?wc=venyoo/default/science&widget_id=6472815257321472"></script>
