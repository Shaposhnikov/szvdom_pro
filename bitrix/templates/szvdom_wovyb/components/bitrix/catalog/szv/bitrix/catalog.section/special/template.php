    ...
    <ul>
        <?foreach( $arResult['ITEMS'] as $value){
            ...
            <li onclick="location.href = '<?=$value["DETAIL_PAGE_URL"];?>'">
                ...
                <a href="<?=$value["DETAIL_PAGE_URL"]?>">
                    <?if (!empty($value["PREVIEW_PICTURE"])  && $value["PREVIEW_PICTURE"]["SRC"] != "/bitrix/templates/szvdom/components/bitrix/catalog/szv/bitrix/catalog.section/.default/images/no_photo.png"){
                        ...
                        if (!empty($imago)){
                            ...
                            echo "<img width='225' height='175' src='/bitrix/templates/szvdom/components/bitrix/catalog/szv/bitrix/catalog.section/.default/images/no_photo.png' alt='".$value["NAME"]."' title='".$value["NAME"]."' />";
                        }
                    }?>
                </a>
                ...
                <p class="pseudoButton">от <?=number_format($value["PROPERTIES"]["FLATCOST_PUBLIC"]["VALUE"][0], 0, ',', ' '); ?> Р</p>
