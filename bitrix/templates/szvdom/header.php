...
<script type="text/javascript" src="/bitrix/templates/szvdom/js/favorites2.js"></script>
<?
...
<!--noindex--><script  defer type="text/javascript" src="<?= SITE_TEMPLATE_PATH ?>/js/fotorama.js"></script><!--/noindex-->
...
<!--noindex--><script  defer type="text/javascript" src="<?= SITE_TEMPLATE_PATH ?>/js/inputmask.js"></script><!--/noindex-->
<!--noindex--><script  defer type="text/javascript" src="<?= SITE_TEMPLATE_PATH ?>/js/jquery.inputmask.js"></script><!--/noindex-->
<link rel="stylesheet" type="text/css" href="<?=SITE_TEMPLATE_PATH?>/css/jquery.datetimepicker.css" media="screen" />
<!--noindex--><script  defer type="text/javascript" src="<?=SITE_TEMPLATE_PATH?>/js/jquery.datetimepicker.full.min.js"></script><!--/noindex-->
<!--noindex--><script   type="text/javascript" src="<?=SITE_TEMPLATE_PATH?>/js/jquery.price_format.2.0.min.js"></script><!--/noindex-->
<!--noindex--><script   type="text/javascript" src="<?=SITE_TEMPLATE_PATH?>/js/jquery.priceformat.min.js"></script><!--/noindex-->
<!--noindex--><script>
...
<script data-skip-moving=true type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter21785827 = new Ya.Metrika({
                    id:21785827,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/21785827" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
...
<script  defer src="http://analytics.alloka.ru/v4/alloka.js" type="text/javascript"></script>
<!-- Alloka Main end-->



<!-- Alloka Form -->
<script  defer src="https://analytics.alloka.ru/integrations/catch_form.js" type="text/javascript"></script>
<!-- Alloka Form end -->

<meta name="wot-verification" content="413cd0ecded79e3bd34a"/>

<script  data-skip-moving="true" src="//st.yagla.ru/js/y.c.js?h=e635744e8c8784188f9bdfceb76a6c15"></script>
            ...
            <div class="headerMainBody">
                ...
                <div class="headerMainBodyRight">
                        <div class="secondColumnBottom">
                            <a data-who="footer_feedback" onclick="yaCounter21785827.reachGoal('call1'); return true;" data-formsend="head_send" class="buttonGreen showIt" style="float: left;width:180px;line-height:36px;height:36px;margin-top:25px;" >ЗАКАЗАТЬ ЗВОНОК</a>
                        </div>
