...
<tr class="boldText titleTable">
<tr class="boldText titleTable">
	<th width="35%" class="priceSZVHeadtd">Тип квартиры</th>
	<th width="15%" class="priceSZVHeadtd">Площадь</th>
	<th width="15%" class="priceSZVHeadtd">Стоимость</th>
	<th width="10%" class="priceSZVHeadtd">В продаже</th>
...
<tr class="titleTable">
	...
	<th class="priceSZVtd" width="30%"><?


switch ($arBlock['roomtype']) {
    case 'Студия':
	echo "<img class=\"img-circle\" src=\"/bitrix/images/seotime/img/flat01.jpg\" alt=\"Студия\">&nbsp;Студия";
        break;
    case '1 ккв':
        echo "<img class=\"img-circle\" src=\"/bitrix/images/seotime/img/flat01.jpg\" alt=\"1-ккв\">&nbsp;1-комнатная";
        break;
    case '1 ккв (Евро)':
        echo "<img class=\"img-circle\" src=\"/bitrix/images/seotime/img/flat01.jpg\" alt=\"1 ккв (Евро)\">&nbsp;1-комнатная (Евро)";
        break;
	case '2 ккв':
        echo "<img class=\"img-circle\" src=\"/bitrix/images/seotime/img/flat02.jpg\" alt=\"2 ккв\">&nbsp;2-комнатная";
        break;
    case '2 ккв (Евро)':
        echo "<img class=\"img-circle\" src=\"/bitrix/images/seotime/img/flat02.jpg\" alt=\"2 ккв (Евро)\">&nbsp;2-комнатная (Евро)";
        break;
    case '3 ккв':
        echo "<img class=\"img-circle\" src=\"/bitrix/images/seotime/img/flat03.jpg\" alt=\"3 ккв\">&nbsp;3-комнатная";
        break;
    case '3 ккв (Евро)':
        echo "<img class=\"img-circle\" src=\"/bitrix/images/seotime/img/flat03.jpg\" alt=\"3 ккв (Евро)\">&nbsp;3-комнатная (Евро)";
        break;
    case '4 ккв':
        echo "<img class=\"img-circle\" src=\"/bitrix/images/seotime/img/flat04.jpg\" alt=\"4 ккв\">&nbsp;4-комнатная";
        break;
    case '4 ккв (Евро)':
        echo "<img class=\"img-circle\" src=\"/bitrix/images/seotime/img/flat04.jpg\" alt=\"4 ккв (Евро)\">&nbsp;4-комнатная (Евро)";
        break;
    case '5 ккв':
        echo "<img class=\"img-circle\" src=\"/bitrix/images/seotime/img/flat04.jpg\" alt=\"5 ккв\">&nbsp;5-комнатная";
        break;
    case '5 ккв (Евро)':
        echo "<img class=\"img-circle\" src=\"/bitrix/images/seotime/img/flat04.jpg\" alt=\"5 ккв (Евро)\">&nbsp;5-комнатная (Евро)";
        break;
...
?></th>
	<th class="priceSZVtd" width="15%">от <?=$arBlock['min_area']?> м<sup>2</sup></th>
	<th class="priceSZVtd" width="15%">от <?=number_format($arBlock['min_price'], 0, ',', ' ')?>&nbsp;руб.</th>
	<th class="priceSZVtd" width="10%"><span class="pricetbl-link"><?=$arBlock['count']?></span></th>
	</tr>
		</table>
</div>
...
<div style="margin: 10px 50px;"> Сейчас в этом ЖК нет квартир в прямой продаже. Узнать есть ли квартиры по переуступке, снятые с брони или квартиры, которые мы не можем публиковать на сайте можно по телефону 8 921 907 1515 или по электронной почте zapros@szvdom.ru.</div>
<?}?>
		<?//=$arResult["NAV_STRING"];?>
</div>
<div id="tableEnd"></div>
<div class="priceTableRight">
	<img src="/bitrix/images/seotime/img/icon06.svg" alt="">
  <div class="heading">Лучшие цены в марте!<span>Узнайте цену квартиры со скидкой</span></div>
  <a href="#form04" class="buttonGreen">Узнать цену</a>
</div>
