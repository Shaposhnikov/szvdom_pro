...
<td onclick="popupElement({'name': '<?= $apartment['buildingplace']['title']; ?>','rooms': '<?= $apartment['rooms'] ?>','endingperiod' : '<?= $apartment['endingperiod'] ?>','corp' : '<?= $apartment['corp'] ?>','floors' : '<?= $apartment['floors'] ?>','flatfloor' : '<?=$apartment['flatfloor'] ?>','stotal' : '<?= $apartment['stotal'] ?>','sroom' : '<?= $apartment['sroom'] ?>','skitchen' : '<?= $apartment['skitchen'] ?>','baseflatcost' : '<?= number_format($apartment['flatcostwithdiscounts'], 0, ',', ' ')  ?>','flatplan' : '<?= $apartment['flatplan'] ?>','scorridor' : '<?= $apartment['scorridor'] ?>','height' : '<?= $apartment['height'] ?>','sbalcony' : '<?= $apartment['sbalcony'] ?>','swatercloset' : '<?= $apartment['swatercloset'] ?>','decoration' : '<?= $apartment['decoration'] ?>'});"><?=number_format($apartment['flatcostwithdiscounts'], 0, ',', ' ')?></td>
            <td><a onclick="yaCounter21785827.reachGoal('send_form'); return true;" data-who="price_plan" class="showIt">Узнать цену со скидкой</a></td>
        <?} else{?>
...
<td class="flatcostwithdiscounts" ondblclick="popupElement({'name': '<?= $apartment['buildingplace']['title']; ?>','rooms': '<?= $apartment['rooms'] ?>','endingperiod' : '<?= $apartment['endingperiod'] ?>','corp' : '<?= $apartment['corp'] ?>','floors' : '<?= $apartment['floors'] ?>','flatfloor' : '<?=$apartment['flatfloor'] ?>','stotal' : '<?= $apartment['stotal'] ?>','sroom' : '<?= $apartment['sroom'] ?>','skitchen' : '<?= $apartment['skitchen'] ?>','baseflatcost' : '<?= number_format($apartment['flatcostwithdiscounts'], 0, ',', ' ')  ?>','flatplan' : '<?= $apartment['flatplan'] ?>','scorridor' : '<?= $apartment['scorridor'] ?>','height' : '<?= $apartment['height'] ?>','sbalcony' : '<?= $apartment['sbalcony'] ?>','swatercloset' : '<?= $apartment['swatercloset'] ?>','decoration' : '<?= $apartment['decoration'] ?>'});"><a onclick="yaCounter21785827.reachGoal('send_form'); return true;" data-who="price_plan" class="showIt flatcostwithdiscounts">Узнать цену со скидкой<?//='( '.number_format($apartment['flatcostwithdiscounts'], 0, ',', ' ').' )'?></a></td>
...
<tr class="titleTable">
	...
	<th class="priceSZVtd" width="20%"><?
	//echo $arBlock['roomtype'];
		//echo "<!--";
		//print_r($arBlock['roomtype']);
		//echo "-->";
...
switch ($arBlock['roomtype']) {
    ...
    case '1 ккв':
        ...
        break;
    case '1 ккв (Евро)':
        echo "1-комнатная (Евро)";
        break;
    case '2 ккв':
        echo "2-комнатная";
        break;
    case '2 ккв (Евро)':
        echo "2-комнатная (Евро)";
        break;
    case '3 ккв':
        echo "3-комнатная";
        break;
    case '3 ккв (Евро)':
        echo "3-комнатная (Евро)";
        break;
    case '4 ккв':
        echo "4-комнатная";
        break;
    case '4 ккв (Евро)':
        echo "4-комнатная (Евро)";
        break;
    case '5 ккв':
        echo "5-комнатная";
        break;
    case '5 ккв (Евро)':
        echo "5-комнатная (Евро)";
        break;
...
?></th>
	...
	<th class="priceSZVtd" width="20%">от <?=number_format($arBlock['min_price'], 0, ',', ' ')?>&nbsp;руб.</th>
