...
<div class="forAllPage newsElementPage">
    ...
    <div class="forAllPageLeftSide">
        <?if (!empty($arResult["DETAIL_PICTURE"])){
            echo "<img width='320' height='240' src='".$arResult["DETAIL_PICTURE"]["SRC"]."' alt='".$arResult["PREVIEW_TEXT"]."' style='float:left;padding: 0 15px 15px 0;' title='".$arResult["PREVIEW_TEXT"]."' />";
        }?>
