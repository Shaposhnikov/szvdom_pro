...
/*
 * Что бы ты провалился, кто это придумал
 * */
$arElementInnerPageVariableAliases = array(
    "pohozhie-obekty",
    "hod-stroitelstva",
    "foto",
    "ipoteka",
...
$hello = $arResult["VARIABLES"]["INNER_PAGE_CODE"];
if (isset($arResult["VARIABLES"]["INNER_PAGE_CODE"]) && !in_array($arResult["VARIABLES"]["INNER_PAGE_CODE"], $arElementInnerPageVariableAliases))
	LocalRedirect($arResult["FOLDER"].$arResult["VARIABLES"]["ELEMENT_CODE"]."/", "404 Not Found");
